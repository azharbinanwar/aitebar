                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Align(
                              alignment: Alignment.centerLeft,
                              child: Text(AppStrings.confirmPassword, style: context.bodyLarge?.copyWith(color: context.primary)),
                            ),
                            BlocSelector<AuthFormCubit, AuthFormState, bool>(
                              bloc: _authFormCubit,
                              ...
                              builder: (context, isObscure) {
                                return TextFormField(
                                  ...
                                  validator: (String? value) => validateConfirmPassword(value, _authFormCubit.state.password),
                            ...
                            TextButton(
                              onPressed: () => context.router.replaceAll([const WelcomeRoute(), SignInRoute()]),
                              child: const Text(AppStrings.alreadyHaveAnAccountLogin),
                            ),
                          ],
                        ),
                      )
